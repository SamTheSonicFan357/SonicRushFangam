...
namespace CharacterController
{
    ...
    {
        [SerializeField]
        public float m_maxSpeed; //ADDED BY ME! Maximum speed the character can reach.
        [SerializeField]
        public float m_skidDecel; //ADDED BY ME! Maximum speed the character can reach.
        [SerializeField]
        ...
        [SerializeField]
        private LayerMask m_WhatIsCeiling;                          // A mask determining what is ceiling to the character
        [SerializeField]
        ...
        private bool m_isTouchingCeiling;   // ADDED BY ME! Checks to see if the player is touching the ceiling.
        ...
        private bool m_isJumping = false; //ADDED BY ME! Check to see if the character is jumping.
        ...
        public void Move(float move, bool crouch) //REMOVED "bool jump"
        {
        ...
        //ADDED BY ME!
        public void ControlVelocity(float directionInput)
        {
        ...
        //ADDED BY ME!
        public void WillJump(bool jumpButtonDown)
        {
